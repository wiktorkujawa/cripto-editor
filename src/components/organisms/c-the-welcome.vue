...
<template>
  <m-welcome-item>
    <template #icon><a-svg src="documentation" /></template>
  ...
  <m-welcome-item>
    <template #icon><a-svg src="tooling" /></template>
  ...
  <m-welcome-item>
    <template #icon><a-svg src="ecosystem" /></template>
  ...
  <m-welcome-item>
    <template #icon><a-svg src="community" /></template>
  ...
  <m-welcome-item>
    <template #icon><a-svg src="support" /></template>
